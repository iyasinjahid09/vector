...
TOKEN = '7062229353:AAGTSFiYsrxZYhvKy9JlYBkhqLouPaealoE'  # Replace with your actual bot token
ADMIN_IDS = [1908670857]  # Added new admin ID
CHANNEL_ID = '-4660632375'  # Replace with your specific channel or group ID
# Initialize the bot
...
def reset_attack_limit(message):
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [Vector bhai ](https://t.me/Vectorbhai) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-4660632375"  # Replace with your actual feedback channel ID
